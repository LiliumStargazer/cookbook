...
function SignInPage() {
    ...
    return (
        <AuthBackground
            ...
            style={{ width: '100vw', minWidth: '100vw', maxWidth: '100vw', color: '#fff', textShadow: '0 2px 8px rgba(0,0,0,0.3)' }}
        >
            <AuthCard
                title="CookBook"
                ...
                action={<button className="btn btn-link" onClick={handleSignUp}>Sign Up</button>}
            >
                <AuthForm
                    fields={[
                        {
