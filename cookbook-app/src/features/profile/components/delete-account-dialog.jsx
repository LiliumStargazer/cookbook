            ...
            <AlertDialogContent className="max-w-md">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="space-y-4">
                        <p>
                            Questa azione eliminerà <strong>definitivamente</strong> il tuo account e tutti i dati associati:
                        </p>
                        ...
                        <div className="mt-4">
                            <Label htmlFor="confirm-delete" className="text-sm font-medium">
                                Per confermare, scrivi <span className="font-mono bg-gray-100 px-1 rounded">ELIMINA</span>:
                            </Label>
                            <Input
                                id="confirm-delete"
                                value={confirmText}
